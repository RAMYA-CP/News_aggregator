...
def homepage(request):
    url = "http://newsapi.org/v2/everything?from=2020-07-19&q=general news&sortBy=popularity&apiKey=8bcdf6bc1bac4a8aa449ff96577b2480"
    ...
    url = "http://newsapi.org/v2/everything?from=2020-07-19&q=top news&sortBy=popularity&apiKey=8bcdf6bc1bac4a8aa449ff96577b2480"
    response = requests.request("GET", url)
    df=json.loads(response.text)
    links=[]
    titles=[]
    ...
    url = "http://newsapi.org/v2/everything?from=2020-07-19&q=entertainment&sortBy=popularity&apiKey=8bcdf6bc1bac4a8aa449ff96577b2480"
    response = requests.request("GET", url)
    df=json.loads(response.text)
    entlinks=[]
    entitles=[]
    ...
    url = "http://newsapi.org/v2/everything?from=2020-07-19&q=sports&sortBy=popularity&apiKey=8bcdf6bc1bac4a8aa449ff96577b2480"
    response = requests.request("GET", url)
    df=json.loads(response.text)
    splinks=[]
    sptitles=[]
